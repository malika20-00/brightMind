...
class CRUDClass extends dbConnection
{
    ...
    public function deleteClass($idClass)
    {
        ...
        $this->dbc->query($sql);
        $sql = "delete from file where idLecon in (select id from lecon where idChapitre in (select id from chapitre where idCours in (select id from cours where idClass = " . $idClass . ")))";
        $this->dbc->query($sql);
        $sql = "delete from file where idChapitre in  (select id from chapitre where idCours in (select id from cours where idClass = " . $idClass . "))";
        $this->dbc->query($sql);
        $sql = "delete from file where idCours in  (select id from cours where idClass = " . $idClass . ")";
        $this->dbc->query($sql);
    ...
    public function readClassByMatiere($matiere){
