...
<?php
			...
			<div class="modal-content">
				<div class="modal-header backgroud-style">
					...
					<div class="popup-text text-center">
						<h2> <span>Add lesson in existing chapter</span></h2>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="affiliate-market-guide mb65">
						...
						<br>
						<div class="section-title-2  headline text-left">
							<h2><span>Add Lesson</span></h2>
						</div>
						<div class="payment-method" style="width: 100%;">

							<div class="check-out-form">
								<form action="prof/include/addLesson.php" method="POST" enctype="multipart/form-data" id="ajouterCours_form">
									<div class="payment-info">
										<label class=" control-label">title :</label>
										<input type="text" class="form-control" name="titre" placeholder="Enter the title of the course" required>
									...
									?>
									<input type="hidden" name="idChapitre" value="<?php echo $idChapitre;?>">
	...
	<script src="./prof/js/addLesson.js"></script>
