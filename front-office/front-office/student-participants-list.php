		...
		<div class="container">
			<div class="page-breadcrumb-content text-center">
				<div class="page-breadcrumb-title">
					<h2 class="breadcrumb-head black bold"><span>Participants</span></h2>
				</div>
										...
										<div class="order-item mb65 course-page-section">
											<div class="course-list-view table-responsive">
												<table class="table">
													...
													<tbody>
														<?php
														$affectations = $etudiant->readStudentsByIdClass($class['id']);
														$crudStudent = new CRUDStudent();
														foreach ($affectations as $affectation) {
															$student = $crudStudent->readStudentById($affectation['idEtudiant']);
														?>
															<tr>
