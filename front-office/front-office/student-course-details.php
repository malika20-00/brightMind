...
?>
	...
	<body>
		...
		$chapitre = $crudCours->readChapitreById($_GET['idChapitre']);
		?>
					...
					<div class="col-md-9">
						<div class="affiliate-market-guide mb65">
							...
							<div class="section-title mb45 headline text-center">
								...
								<h2 style="font-size: 30px;"><?php echo $chapitre['titre']; ?></h2>
							</div>
							<div>
								
								<?php $files = $crudCours->readFilesByIdChapitre($chapitre['id']);
								foreach ($files as $file) {
									if ($etudiant->typeOfFile($file['nom']) == "pdf") { ?>
										<div class="iframParent">
											<iframe src="<?php echo $file['nom']; ?>" scrolling="no" seamless="seamless"></iframe>
											<button class="ouvrirPdf"><a href="../include/lirePdf.php?name=<?php echo $file['nom']; ?>">Open file</a></button>
										</div>
									<?php } else if ($etudiant->typeOfFile($file['nom']) == "img") { ?>
										<img src="<?php echo $file['nom']; ?>" alt="" style="margin: 20px 20px;">

									<?php } else { ?>
										<video controls style="width: 100%; margin: 20px 20px;">
											<source src="<?php $file['nom'] ?>" type="video/mp4">
											<source src="<?php $file['nom'] ?>" type="video/webm">
								...
								<?php $Lecon = $crudCours->readLeconByIdChapitre($_GET['idChapitre']);
								foreach ($Lecon as $lecon) { ?>
									<h6 class="titre"> <?php echo $lecon['titre']; ?></h6>
									<?php echo $lecon['contenu']; ?>
									<?php $files = $crudCours->readFilesByIdLecon($lecon['id']);
									foreach ($files as $file) {
										if ($etudiant->typeOfFile($file['nom']) == "pdf") { ?>
											<div class="iframParent">
												<iframe src="prof/include/files/<?php echo $file['nom']; ?>" scrolling="no" seamless="seamless"></iframe>
												<button class="ouvrirPdf"><a href="prof/include/files/<?php echo $file['nom']; ?>" target="_blanck">Open file</a></button>
											</div>
										<?php } else if ($etudiant->typeOfFile($file['nom']) == "img") { ?>
											<img src="<?php echo $file['nom']; ?>" alt="" style="margin: 20px 20px;">
