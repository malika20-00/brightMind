...
<?php
 ...
 -->
				...
				<div class="col-md-12">
					<div class="affiliate-market-guide mb65">
						...
						<div class="payment-method" style="width: 100%;">
							...
							<div class="check-out-form">
								<form action="prof/include/enregistrerFile.php" method="POST" enctype="multipart/form-data" id="ajouterCours_form">
									<div class="payment-info">
										<label class=" control-label">title :</label>
										<input required type="text" class="form-control" name="titre" placeholder="Enter the title of the course">
									...
									<textarea name="editor" id="editor" class="ckeditor form-control "> </textarea>
	...
	<script src="./prof/js/addcourse.js"></script>
