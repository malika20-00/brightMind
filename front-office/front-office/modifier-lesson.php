...
<div class="modal fade" id="deletefile" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="affiliate-market-guide mb65">
						...
						<br>
						<div class="section-title-2  headline text-left">
							<h2><span>update Lesson</span></h2>
						</div>
						<div class="payment-method" style="width: 100%;">

							<div class="check-out-form">
								<form action="prof/include/modifierLecon.php" method="POST" enctype="multipart/form-data" id="modifierLecon_form">
									<div class="payment-info">
										<label class=" control-label">title :</label>
										<input type="text" class="form-control" name="titre" placeholder="Enter the title of the course" value="<?php echo $lecon['titre']?> "> 
										<p class="error" id="titreError"></p>
									</div>
									<div class="payment-info">
										<label for="exampleFormControlTextarea1">Description</label>
										<textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="description" ><?php echo $lecon['description']?></textarea>
									...
									<textarea name="editor" id="editor" class="form-control ckeditor"> <?php echo $lecon['contenu']?></textarea>
							...
							<?php } ?>
									...
									<input type="hidden" name="idLecon" value="<?php echo $idLecon;?>">
    ...
    <script src="./prof/js/modifierLecon.js"></script>
