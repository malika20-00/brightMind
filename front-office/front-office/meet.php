...
?>
				...
				<div class="col-md-9">
					<div class="affiliate-market-guide mb65">
						...
						<div class="section-title-2 mb20 headline text-left ">
							<h2 class="underline"><span>Class Name</span></h2>
						</div>
							...
							<h2>NEW MEETING</h2>
									...
									<div class="order-payment">
										<div class="section-title-2  headline text-left">
											<h2> fill in the <span>form</span></h2>
										</div>
											...
											<div class="check-out-form">
												...
												<input type="hidden" name="idClass" value="<?php echo $idClass;?>">
													<div class="payment-info">
														...
														<input type="text" class="form-control"  name='lien' placeholder="Enter the link of your card" >
														<p class="error" id="lienError" ></p>
													</div>
													<div class="payment-info">
														<label class=" control-label"> Description:</label>
														<input type="text" class="form-control"  name="description" placeholder="Enter Your Number" >
													...
													<div>
														...
														<input type="submit" class="genius-btn" id="ajouter" value="ajouter">
										...
										<div class="card" style="border: transparent ;background: rgb(241, 243, 245);">
											...
											<div style="position: relative;padding-top: 5px;">
												<span>class : <?php $class = $prof->getClassById($meet['idClass']);
																echo $class['nom']; ?> </span>
												<a href="<?php echo $meet['lien']; ?>" style="position: absolute;
									right: 0; top: 0px;border: solid 1px #e1dede; padding: 5px 10px; border-radius :20px;box-shadow: rgba(50, 50, 93, 0.25) 0px 2px 5px -1px, rgba(0, 0, 0, 0.3) 0px 1px 3px -1px;"><i class='fas fa-video' style="margin-right: 20px;"></i>Join meet
												</a>
											</div>
   ...
   <?php include('footerProf.php'); ?>
	<!-- End of footer section
		...
		<script src="./prof/js/ajouterMeet.js"></script>
	</body>
	</html>
<?php } ?>
