...
?>
								<div class="media g-mb-30 media-comment">
									...
									<div class="media-body u-shadow-v18 g-bg-secondary g-pa-30">
										<div class="g-mb-15">
											<h5 class="h5 g-color-gray-dark-v1 mb-0" style="color:#000;"><?php if($etudiant){echo $etudiant['prenom']." ".$etudiant['nom'];} else{ echo $profActuel['prenom']." ".$profActuel['nom'];} ?></h5>
...
foreach($prof->comment_child($comment['id']) as $comment){ ?>  
 <div class="fils">
    ...
    <?php require("commentaireStudent.php"); ?>
</div>
<?php }?>
<style>
.fils {
