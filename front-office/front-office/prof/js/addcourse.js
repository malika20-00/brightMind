  ...
  //   xhr.open("POST", "prof/include/enregistrerFile.php", true);
  
  //   xhr.responseType = "json";
  //   xhr.send(data);
  
  // });
  // Array.prototype.forEach.call(document.querySelectorAll("#ajouterCours_form  input,#ajouterCours_form  textarea"), function (el) {
