...
<div>
    ...
    <div class="order-payment" style="width:500px; margin: auto; margin-top: 100px;">
        ...
        <div class="payment-method">
            ...
            <h2 class="widget-title" style="font-size: large;">To continue, please confirm your email</h2>
                <form id="oubliePw" action="#" method="post">	
                   
                    <div class="payment-info">
                        
                        <input id="email" type="text" class="form-control"  name="email" placeholder="Confirm your email" value="" style="width: 500px;">
                    </div>
                    <div >
                        <input class="genius-btn mt25 gradient-bg text-center text-uppercase  bold-font" style="width: 500px;border:none;" id="oublieSubmit" type="submit"  value="Get Code" > 
